function copiarDatos() {
  ...
  var numero = hojaOrigen.getRange('R7:U10').getValue(); // Obtener el número ingresado
  ...
  if (numero < 2 || numero > 1000) {
    SpreadsheetApp.getUi().alert('Ingrese un número válido en la celda R7:U10');
    return;
  }
  
  // Definir el rango de celdas según el número ingresado
  var rangoCeldas = 'A' + numero + ':AH' + numero;
  ...
  hojaOrigen.getRange('R7:U10').clearContent();
