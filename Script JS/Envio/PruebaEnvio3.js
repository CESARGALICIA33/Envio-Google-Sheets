function copiarDatos3() {
  ...
  var numero = hojaOrigen.getRange('CN7:CQ10').getValue(); // Obtener el número ingresado
  ...
  if (numero < 2 || numero > 1000) {
    SpreadsheetApp.getUi().alert('Ingrese un número válido en la celda CN7:CQ10');
    return;
  }
  
  // Definir el rango de celdas según el número ingresado
  var rangoCeldas = 'BV' + numero + ':DC' + numero;
  ...
  hojaOrigen.getRange('CN7:CQ10').clearContent();
